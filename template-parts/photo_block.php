...
<div class="photosApparentees">
    <div class="blocPhotosApparentees">
        <div class= "affichagePhotoApparantees"<?php echo $photoApparentee->posts[0]->post_content; ?>></div>
        <?php
            if(isset($photoApparentee->posts[1])):
        ?>
        <div class= "affichagePhotoApparantees"<?php echo $photoApparentee->posts[1]->post_content; ?>></div>
        <?php
            endif;
        ?>
    </div>
